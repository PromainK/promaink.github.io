function bingosetup() {
    ...
    window.history.replaceState(null, null, "bingo-simple.html?&seed=" + bingoOpts.seed + "&mode=" + cardType.toLowerCase() + "&lang=" + bingoOpts.lang);
    
    var seed_info = "bingo-simple.html?&seed=" + bingoOpts.seed + "&mode=" + cardType.toLowerCase() + "&lang=";
